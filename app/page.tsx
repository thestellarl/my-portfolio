...
function App(): React.ReactNode {
  ...
  return (
    ...
    >
      <div className="social-links absolute flex space-x-8 bottom-6 z-10 max-w-screen-xl w-full md:px-12 md:left-12 md:bottom-12 lg:left-24 mx-auto pointer-events-none">
        <a
          className=""
          target="_blank"
